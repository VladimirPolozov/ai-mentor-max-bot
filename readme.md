...
Структура проекта соответствует принципам Clean Architecture, что позволяет легко расширять его и интегрировать в него новые команды, поддержку других направлений, заменять модели, веб-интерфейс и т.п.
